...
public class Stagiaire extends User implements Serializable {
	...
	public String toString() {
		...
		return super.toString() + " Stagiaire [dateNaissance=" + dateNaissance
				+ ", tel=" + tel + ", adresse=" + adresse + ", codePostal="
				+ codePostal + ", ville=" + ville + ", sexe=" + sexe
				+ ", diplome=" + diplome + ", domaine=" + domaine
